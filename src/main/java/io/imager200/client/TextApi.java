...
public class TextApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse textAsyncPost(String text, File body, String color, String font, BigDecimal size, Integer x, Integer y) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = textAsyncPostWithHttpInfo(text, body, color, font, size, x, y);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> textAsyncPostWithHttpInfo(String text, File body, String color, String font, BigDecimal size, Integer x, Integer y) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = textAsyncPostRequestBuilder(text, body, color, font, size, x, y);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder textAsyncPostRequestBuilder(String text, File body, String color, String font, BigDecimal size, Integer x, Integer y) throws ApiException {
    // verify the required parameter 'text' is set
    if (text == null) {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling textAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File textSyncPost(String text, File body, String color, String font, BigDecimal size, Integer x, Integer y) throws ApiException {
    ApiResponse<File> localVarResponse = textSyncPostWithHttpInfo(text, body, color, font, size, x, y);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> textSyncPostWithHttpInfo(String text, File body, String color, String font, BigDecimal size, Integer x, Integer y) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = textSyncPostRequestBuilder(text, body, color, font, size, x, y);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder textSyncPostRequestBuilder(String text, File body, String color, String font, BigDecimal size, Integer x, Integer y) throws ApiException {
    // verify the required parameter 'text' is set
    if (text == null) {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling textSyncPost");
    }
