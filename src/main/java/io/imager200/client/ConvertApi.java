...
public class ConvertApi {
   ...
   * @param targetFormat  (optional)
   * @return InfoResponse
   * @throws ApiException if fails to make API call
   */
  public InfoResponse convertAsyncGet(String url, String targetFormat) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = convertAsyncGetWithHttpInfo(url, targetFormat);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> convertAsyncGetWithHttpInfo(String url, String targetFormat) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = convertAsyncGetRequestBuilder(url, targetFormat);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("convertAsyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder convertAsyncGetRequestBuilder(String url, String targetFormat) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling convertAsyncGet");
    }
    ...
    localVarQueryParameterBaseName = "targetFormat";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("targetFormat", targetFormat));
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse convertAsyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, String targetFormat) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = convertAsyncPostWithHttpInfo(brightnessAsyncPostRequest, targetFormat);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> convertAsyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, String targetFormat) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = convertAsyncPostRequestBuilder(brightnessAsyncPostRequest, targetFormat);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("convertAsyncPost", localVarResponse);
        }
        return new ApiResponse<InfoResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder convertAsyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, String targetFormat) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling convertAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File convertSyncGet(String url, String targetFormat) throws ApiException {
    ApiResponse<File> localVarResponse = convertSyncGetWithHttpInfo(url, targetFormat);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> convertSyncGetWithHttpInfo(String url, String targetFormat) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = convertSyncGetRequestBuilder(url, targetFormat);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("convertSyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder convertSyncGetRequestBuilder(String url, String targetFormat) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling convertSyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/convert/sync";
   ...
   * @throws ApiException if fails to make API call
   */
  public File convertSyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, String targetFormat) throws ApiException {
    ApiResponse<File> localVarResponse = convertSyncPostWithHttpInfo(brightnessAsyncPostRequest, targetFormat);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> convertSyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, String targetFormat) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = convertSyncPostRequestBuilder(brightnessAsyncPostRequest, targetFormat);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("convertSyncPost", localVarResponse);
        }
        return new ApiResponse<File>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder convertSyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, String targetFormat) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling convertSyncPost");
    }
