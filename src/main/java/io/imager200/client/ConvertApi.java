...
public class ConvertApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse convertAsyncPost(File body, String targetFormat) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = convertAsyncPostWithHttpInfo(body, targetFormat);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> convertAsyncPostWithHttpInfo(File body, String targetFormat) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = convertAsyncPostRequestBuilder(body, targetFormat);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder convertAsyncPostRequestBuilder(File body, String targetFormat) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling convertAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File convertSyncPost(File body, String targetFormat) throws ApiException {
    ApiResponse<File> localVarResponse = convertSyncPostWithHttpInfo(body, targetFormat);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> convertSyncPostWithHttpInfo(File body, String targetFormat) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = convertSyncPostRequestBuilder(body, targetFormat);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder convertSyncPostRequestBuilder(File body, String targetFormat) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling convertSyncPost");
    }
