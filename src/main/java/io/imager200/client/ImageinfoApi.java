...
public class ImageinfoApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public ImageMetadata imageinfoSyncPost(File body) throws ApiException {
    ApiResponse<ImageMetadata> localVarResponse = imageinfoSyncPostWithHttpInfo(body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ImageMetadata> imageinfoSyncPostWithHttpInfo(File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = imageinfoSyncPostRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder imageinfoSyncPostRequestBuilder(File body) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling imageinfoSyncPost");
    }
