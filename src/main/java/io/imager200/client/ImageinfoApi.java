...
import io.imager200.model.ImageMetadata;
...
public class ImageinfoApi {
  ...
  public ImageinfoApi(ApiClient apiClient) {
   ...
   */
  public ImageMetadata imageinfoSyncGet(String url) throws ApiException {
    ApiResponse<ImageMetadata> localVarResponse = imageinfoSyncGetWithHttpInfo(url);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ImageMetadata> imageinfoSyncGetWithHttpInfo(String url) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = imageinfoSyncGetRequestBuilder(url);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("imageinfoSyncGet", localVarResponse);
        }
        return new ApiResponse<ImageMetadata>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
          localVarResponse.body() == null ? null : memberVarObjectMapper.readValue(localVarResponse.body(), new TypeReference<ImageMetadata>() {}) // closes the InputStream
        );
      } finally {
      }
    } catch (IOException e) {
  ...
  private HttpRequest.Builder imageinfoSyncGetRequestBuilder(String url) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling imageinfoSyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/imageinfo";
   ...
   * @throws ApiException if fails to make API call
   */
  public ImageMetadata imageinfoSyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    ApiResponse<ImageMetadata> localVarResponse = imageinfoSyncPostWithHttpInfo(brightnessAsyncPostRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<ImageMetadata> imageinfoSyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = imageinfoSyncPostRequestBuilder(brightnessAsyncPostRequest);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("imageinfoSyncPost", localVarResponse);
        }
        return new ApiResponse<ImageMetadata>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder imageinfoSyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling imageinfoSyncPost");
    }
