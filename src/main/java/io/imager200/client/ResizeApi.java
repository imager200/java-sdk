...
public class ResizeApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse resizeAsyncPost(Integer height, Integer width, BrightnessAsyncPostRequest brightnessAsyncPostRequest, String resamplingAlgorithm) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = resizeAsyncPostWithHttpInfo(height, width, brightnessAsyncPostRequest, resamplingAlgorithm);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> resizeAsyncPostWithHttpInfo(Integer height, Integer width, BrightnessAsyncPostRequest brightnessAsyncPostRequest, String resamplingAlgorithm) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = resizeAsyncPostRequestBuilder(height, width, brightnessAsyncPostRequest, resamplingAlgorithm);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder resizeAsyncPostRequestBuilder(Integer height, Integer width, BrightnessAsyncPostRequest brightnessAsyncPostRequest, String resamplingAlgorithm) throws ApiException {
    // verify the required parameter 'height' is set
    if (height == null) {
    ...
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling resizeAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File resizeSyncPost(Integer height, Integer width, BrightnessAsyncPostRequest brightnessAsyncPostRequest, String resamplingAlgorithm) throws ApiException {
    ApiResponse<File> localVarResponse = resizeSyncPostWithHttpInfo(height, width, brightnessAsyncPostRequest, resamplingAlgorithm);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> resizeSyncPostWithHttpInfo(Integer height, Integer width, BrightnessAsyncPostRequest brightnessAsyncPostRequest, String resamplingAlgorithm) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = resizeSyncPostRequestBuilder(height, width, brightnessAsyncPostRequest, resamplingAlgorithm);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder resizeSyncPostRequestBuilder(Integer height, Integer width, BrightnessAsyncPostRequest brightnessAsyncPostRequest, String resamplingAlgorithm) throws ApiException {
    // verify the required parameter 'height' is set
    if (height == null) {
    ...
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling resizeSyncPost");
    }
