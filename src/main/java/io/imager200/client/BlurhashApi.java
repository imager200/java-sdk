...
public class BlurhashApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse blurhashAsyncPost(File body) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = blurhashAsyncPostWithHttpInfo(body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> blurhashAsyncPostWithHttpInfo(File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurhashAsyncPostRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder blurhashAsyncPostRequestBuilder(File body) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling blurhashAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File blurhashSyncPost(File body) throws ApiException {
    ApiResponse<File> localVarResponse = blurhashSyncPostWithHttpInfo(body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> blurhashSyncPostWithHttpInfo(File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurhashSyncPostRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder blurhashSyncPostRequestBuilder(File body) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling blurhashSyncPost");
    }
