...
public class GrayscaleApi {
  ...
  public GrayscaleApi(ApiClient apiClient) {
   ...
   */
  public InfoResponse grayscaleAsyncGet(String url) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = grayscaleAsyncGetWithHttpInfo(url);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> grayscaleAsyncGetWithHttpInfo(String url) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = grayscaleAsyncGetRequestBuilder(url);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("grayscaleAsyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder grayscaleAsyncGetRequestBuilder(String url) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling grayscaleAsyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/grayscale";
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse grayscaleAsyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = grayscaleAsyncPostWithHttpInfo(brightnessAsyncPostRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> grayscaleAsyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = grayscaleAsyncPostRequestBuilder(brightnessAsyncPostRequest);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("grayscaleAsyncPost", localVarResponse);
        }
        return new ApiResponse<InfoResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder grayscaleAsyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling grayscaleAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File grayscaleSyncGet(String url) throws ApiException {
    ApiResponse<File> localVarResponse = grayscaleSyncGetWithHttpInfo(url);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> grayscaleSyncGetWithHttpInfo(String url) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = grayscaleSyncGetRequestBuilder(url);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("grayscaleSyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder grayscaleSyncGetRequestBuilder(String url) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling grayscaleSyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/grayscale/sync";
   ...
   * @throws ApiException if fails to make API call
   */
  public File grayscaleSyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    ApiResponse<File> localVarResponse = grayscaleSyncPostWithHttpInfo(brightnessAsyncPostRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> grayscaleSyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = grayscaleSyncPostRequestBuilder(brightnessAsyncPostRequest);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("grayscaleSyncPost", localVarResponse);
        }
        return new ApiResponse<File>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder grayscaleSyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling grayscaleSyncPost");
    }
