...
public class GrayscaleApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse grayscaleAsyncPost(File body) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = grayscaleAsyncPostWithHttpInfo(body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> grayscaleAsyncPostWithHttpInfo(File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = grayscaleAsyncPostRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder grayscaleAsyncPostRequestBuilder(File body) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling grayscaleAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File grayscaleSyncPost(File body) throws ApiException {
    ApiResponse<File> localVarResponse = grayscaleSyncPostWithHttpInfo(body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> grayscaleSyncPostWithHttpInfo(File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = grayscaleSyncPostRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder grayscaleSyncPostRequestBuilder(File body) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling grayscaleSyncPost");
    }
