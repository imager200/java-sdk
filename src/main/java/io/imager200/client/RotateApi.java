...
public class RotateApi {
  ...
  public RotateApi(ApiClient apiClient) {
   ...
   * @param angle rotation angle in degrees (optional, default to 90)
   * @param backgroundColor the color that should be used to fill the empty surfaces after rotating the image. Must be a valid color name (supported names are specified [here](https://www.w3schools.com/colors/colors_names.asp)) or hexadecimal code. (optional, default to white)
   * @return InfoResponse
   * @throws ApiException if fails to make API call
   */
  public InfoResponse rotateAsyncGet(String url, BigDecimal angle, String backgroundColor) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = rotateAsyncGetWithHttpInfo(url, angle, backgroundColor);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> rotateAsyncGetWithHttpInfo(String url, BigDecimal angle, String backgroundColor) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = rotateAsyncGetRequestBuilder(url, angle, backgroundColor);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("rotateAsyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder rotateAsyncGetRequestBuilder(String url, BigDecimal angle, String backgroundColor) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling rotateAsyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/rotate";
    ...
    localVarQueryParameterBaseName = "angle";
    localVarQueryParams.addAll(ApiClient.parameterToPairs("angle", angle));
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse rotateAsyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal angle, String backgroundColor) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = rotateAsyncPostWithHttpInfo(brightnessAsyncPostRequest, angle, backgroundColor);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> rotateAsyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal angle, String backgroundColor) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = rotateAsyncPostRequestBuilder(brightnessAsyncPostRequest, angle, backgroundColor);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("rotateAsyncPost", localVarResponse);
        }
        return new ApiResponse<InfoResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder rotateAsyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal angle, String backgroundColor) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling rotateAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File rotateSyncGet(String url, BigDecimal angle, String backgroundColor) throws ApiException {
    ApiResponse<File> localVarResponse = rotateSyncGetWithHttpInfo(url, angle, backgroundColor);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> rotateSyncGetWithHttpInfo(String url, BigDecimal angle, String backgroundColor) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = rotateSyncGetRequestBuilder(url, angle, backgroundColor);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("rotateSyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder rotateSyncGetRequestBuilder(String url, BigDecimal angle, String backgroundColor) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling rotateSyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/rotate/sync";
   ...
   * @throws ApiException if fails to make API call
   */
  public File rotateSyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal angle, String backgroundColor) throws ApiException {
    ApiResponse<File> localVarResponse = rotateSyncPostWithHttpInfo(brightnessAsyncPostRequest, angle, backgroundColor);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> rotateSyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal angle, String backgroundColor) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = rotateSyncPostRequestBuilder(brightnessAsyncPostRequest, angle, backgroundColor);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("rotateSyncPost", localVarResponse);
        }
        return new ApiResponse<File>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder rotateSyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal angle, String backgroundColor) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling rotateSyncPost");
    }
