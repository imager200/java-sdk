...
public class RotateApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse rotateAsyncPost(File body, BigDecimal angle, String backgroundColor) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = rotateAsyncPostWithHttpInfo(body, angle, backgroundColor);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> rotateAsyncPostWithHttpInfo(File body, BigDecimal angle, String backgroundColor) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = rotateAsyncPostRequestBuilder(body, angle, backgroundColor);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder rotateAsyncPostRequestBuilder(File body, BigDecimal angle, String backgroundColor) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling rotateAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File rotateSyncPost(File body, BigDecimal angle, String backgroundColor) throws ApiException {
    ApiResponse<File> localVarResponse = rotateSyncPostWithHttpInfo(body, angle, backgroundColor);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> rotateSyncPostWithHttpInfo(File body, BigDecimal angle, String backgroundColor) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = rotateSyncPostRequestBuilder(body, angle, backgroundColor);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder rotateSyncPostRequestBuilder(File body, BigDecimal angle, String backgroundColor) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling rotateSyncPost");
    }
