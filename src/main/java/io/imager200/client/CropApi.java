...
public class CropApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse cropAsyncPost(Integer x0, Integer x1, Integer y0, Integer y1, File body) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = cropAsyncPostWithHttpInfo(x0, x1, y0, y1, body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> cropAsyncPostWithHttpInfo(Integer x0, Integer x1, Integer y0, Integer y1, File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = cropAsyncPostRequestBuilder(x0, x1, y0, y1, body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder cropAsyncPostRequestBuilder(Integer x0, Integer x1, Integer y0, Integer y1, File body) throws ApiException {
    // verify the required parameter 'x0' is set
    if (x0 == null) {
    ...
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling cropAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File cropSyncPost(Integer x0, Integer x1, Integer y0, Integer y1, File body) throws ApiException {
    ApiResponse<File> localVarResponse = cropSyncPostWithHttpInfo(x0, x1, y0, y1, body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> cropSyncPostWithHttpInfo(Integer x0, Integer x1, Integer y0, Integer y1, File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = cropSyncPostRequestBuilder(x0, x1, y0, y1, body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder cropSyncPostRequestBuilder(Integer x0, Integer x1, Integer y0, Integer y1, File body) throws ApiException {
    // verify the required parameter 'x0' is set
    if (x0 == null) {
    ...
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling cropSyncPost");
    }
