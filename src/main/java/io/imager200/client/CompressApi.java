...
import io.imager200.model.CompressAsyncPostRequest;
...
public class CompressApi {
   ...
   * 
   * This endpoint compresses the image according to the parameters.
   * @param compressAsyncPostRequest  (required)
   * @param jpegQuality defines the jpeg quality level (the higher is the value, the better quality of the image). Only applied if the image is of type jpeg. (uses MozJPEG behind the curtains) (optional, default to 95)
   * @param pngOptimizationLevel defines the png optimization level (higher value means a smaller size and longer compression time). Only applied if image is of type png. (optional, default to 3)
   * @param progressiveJpeg It toggles the generation of a progressive JPEG. A \&quot;false\&quot; value generates a baseline JPEG (optional, default to true)
   * @return InfoResponse
   * @throws ApiException if fails to make API call
   */
  public InfoResponse compressAsyncPost(CompressAsyncPostRequest compressAsyncPostRequest, Integer jpegQuality, Integer pngOptimizationLevel, Boolean progressiveJpeg) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = compressAsyncPostWithHttpInfo(compressAsyncPostRequest, jpegQuality, pngOptimizationLevel, progressiveJpeg);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> compressAsyncPostWithHttpInfo(CompressAsyncPostRequest compressAsyncPostRequest, Integer jpegQuality, Integer pngOptimizationLevel, Boolean progressiveJpeg) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = compressAsyncPostRequestBuilder(compressAsyncPostRequest, jpegQuality, pngOptimizationLevel, progressiveJpeg);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder compressAsyncPostRequestBuilder(CompressAsyncPostRequest compressAsyncPostRequest, Integer jpegQuality, Integer pngOptimizationLevel, Boolean progressiveJpeg) throws ApiException {
    // verify the required parameter 'compressAsyncPostRequest' is set
    if (compressAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'compressAsyncPostRequest' when calling compressAsyncPost");
    }
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(compressAsyncPostRequest);
   ...
   * @throws ApiException if fails to make API call
   */
  public File compressSyncPost(CompressAsyncPostRequest compressAsyncPostRequest, Integer jpegQuality, Integer pngOptimizationLevel, Boolean progressiveJpeg) throws ApiException {
    ApiResponse<File> localVarResponse = compressSyncPostWithHttpInfo(compressAsyncPostRequest, jpegQuality, pngOptimizationLevel, progressiveJpeg);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> compressSyncPostWithHttpInfo(CompressAsyncPostRequest compressAsyncPostRequest, Integer jpegQuality, Integer pngOptimizationLevel, Boolean progressiveJpeg) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = compressSyncPostRequestBuilder(compressAsyncPostRequest, jpegQuality, pngOptimizationLevel, progressiveJpeg);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder compressSyncPostRequestBuilder(CompressAsyncPostRequest compressAsyncPostRequest, Integer jpegQuality, Integer pngOptimizationLevel, Boolean progressiveJpeg) throws ApiException {
    // verify the required parameter 'compressAsyncPostRequest' is set
    if (compressAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'compressAsyncPostRequest' when calling compressSyncPost");
    }
