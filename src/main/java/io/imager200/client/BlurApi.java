...
public class BlurApi {
  ...
  public BlurApi(ApiClient apiClient) {
   ...
   */
  public InfoResponse blurAsyncGet(String url, BigDecimal sigma) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = blurAsyncGetWithHttpInfo(url, sigma);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> blurAsyncGetWithHttpInfo(String url, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurAsyncGetRequestBuilder(url, sigma);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("blurAsyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder blurAsyncGetRequestBuilder(String url, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling blurAsyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/blur";
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse blurAsyncPost(BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = blurAsyncPostWithHttpInfo(blurAsyncPostRequest, sigma);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> blurAsyncPostWithHttpInfo(BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurAsyncPostRequestBuilder(blurAsyncPostRequest, sigma);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("blurAsyncPost", localVarResponse);
        }
        return new ApiResponse<InfoResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder blurAsyncPostRequestBuilder(BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'blurAsyncPostRequest' is set
    if (blurAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'blurAsyncPostRequest' when calling blurAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File blurSyncGet(String url, BigDecimal sigma) throws ApiException {
    ApiResponse<File> localVarResponse = blurSyncGetWithHttpInfo(url, sigma);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> blurSyncGetWithHttpInfo(String url, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurSyncGetRequestBuilder(url, sigma);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("blurSyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder blurSyncGetRequestBuilder(String url, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling blurSyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/blur/sync";
   ...
   * @throws ApiException if fails to make API call
   */
  public File blurSyncPost(BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    ApiResponse<File> localVarResponse = blurSyncPostWithHttpInfo(blurAsyncPostRequest, sigma);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> blurSyncPostWithHttpInfo(BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurSyncPostRequestBuilder(blurAsyncPostRequest, sigma);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("blurSyncPost", localVarResponse);
        }
        return new ApiResponse<File>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder blurSyncPostRequestBuilder(BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'blurAsyncPostRequest' is set
    if (blurAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'blurAsyncPostRequest' when calling blurSyncPost");
    }
