...
public class BlurApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse blurAsyncPost(File body, BigDecimal sigma) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = blurAsyncPostWithHttpInfo(body, sigma);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> blurAsyncPostWithHttpInfo(File body, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurAsyncPostRequestBuilder(body, sigma);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder blurAsyncPostRequestBuilder(File body, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling blurAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File blurSyncPost(File body, BigDecimal sigma) throws ApiException {
    ApiResponse<File> localVarResponse = blurSyncPostWithHttpInfo(body, sigma);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> blurSyncPostWithHttpInfo(File body, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurSyncPostRequestBuilder(body, sigma);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder blurSyncPostRequestBuilder(File body, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling blurSyncPost");
    }
