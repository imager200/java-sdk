...
public class EqualizeApi {
  ...
  public EqualizeApi(ApiClient apiClient) {
   ...
   */
  public InfoResponse equalizeAsyncGet(String url) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = equalizeAsyncGetWithHttpInfo(url);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> equalizeAsyncGetWithHttpInfo(String url) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = equalizeAsyncGetRequestBuilder(url);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("equalizeAsyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder equalizeAsyncGetRequestBuilder(String url) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling equalizeAsyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/equalize";
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse equalizeAsyncPost(BlurAsyncPostRequest blurAsyncPostRequest) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = equalizeAsyncPostWithHttpInfo(blurAsyncPostRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> equalizeAsyncPostWithHttpInfo(BlurAsyncPostRequest blurAsyncPostRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = equalizeAsyncPostRequestBuilder(blurAsyncPostRequest);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("equalizeAsyncPost", localVarResponse);
        }
        return new ApiResponse<InfoResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder equalizeAsyncPostRequestBuilder(BlurAsyncPostRequest blurAsyncPostRequest) throws ApiException {
    // verify the required parameter 'blurAsyncPostRequest' is set
    if (blurAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'blurAsyncPostRequest' when calling equalizeAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File equalizeSyncGet(String url) throws ApiException {
    ApiResponse<File> localVarResponse = equalizeSyncGetWithHttpInfo(url);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> equalizeSyncGetWithHttpInfo(String url) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = equalizeSyncGetRequestBuilder(url);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("equalizeSyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder equalizeSyncGetRequestBuilder(String url) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling equalizeSyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/equalize/sync";
   ...
   * @throws ApiException if fails to make API call
   */
  public File equalizeSyncPost(BlurAsyncPostRequest blurAsyncPostRequest) throws ApiException {
    ApiResponse<File> localVarResponse = equalizeSyncPostWithHttpInfo(blurAsyncPostRequest);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> equalizeSyncPostWithHttpInfo(BlurAsyncPostRequest blurAsyncPostRequest) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = equalizeSyncPostRequestBuilder(blurAsyncPostRequest);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("equalizeSyncPost", localVarResponse);
        }
        return new ApiResponse<File>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder equalizeSyncPostRequestBuilder(BlurAsyncPostRequest blurAsyncPostRequest) throws ApiException {
    // verify the required parameter 'blurAsyncPostRequest' is set
    if (blurAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'blurAsyncPostRequest' when calling equalizeSyncPost");
    }
