...
public class EqualizeApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse equalizeAsyncPost(File body) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = equalizeAsyncPostWithHttpInfo(body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> equalizeAsyncPostWithHttpInfo(File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = equalizeAsyncPostRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder equalizeAsyncPostRequestBuilder(File body) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling equalizeAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File equalizeSyncPost(File body) throws ApiException {
    ApiResponse<File> localVarResponse = equalizeSyncPostWithHttpInfo(body);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> equalizeSyncPostWithHttpInfo(File body) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = equalizeSyncPostRequestBuilder(body);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder equalizeSyncPostRequestBuilder(File body) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling equalizeSyncPost");
    }
