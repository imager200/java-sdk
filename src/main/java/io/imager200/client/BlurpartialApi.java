...
public class BlurpartialApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse blurpartialAsyncPost(Integer x0, Integer x1, Integer y0, Integer y1, BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = blurpartialAsyncPostWithHttpInfo(x0, x1, y0, y1, blurAsyncPostRequest, sigma);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> blurpartialAsyncPostWithHttpInfo(Integer x0, Integer x1, Integer y0, Integer y1, BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurpartialAsyncPostRequestBuilder(x0, x1, y0, y1, blurAsyncPostRequest, sigma);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder blurpartialAsyncPostRequestBuilder(Integer x0, Integer x1, Integer y0, Integer y1, BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'x0' is set
    if (x0 == null) {
    ...
    if (blurAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'blurAsyncPostRequest' when calling blurpartialAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File blurpartialSyncPost(Integer x0, Integer x1, Integer y0, Integer y1, BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    ApiResponse<File> localVarResponse = blurpartialSyncPostWithHttpInfo(x0, x1, y0, y1, blurAsyncPostRequest, sigma);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> blurpartialSyncPostWithHttpInfo(Integer x0, Integer x1, Integer y0, Integer y1, BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blurpartialSyncPostRequestBuilder(x0, x1, y0, y1, blurAsyncPostRequest, sigma);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder blurpartialSyncPostRequestBuilder(Integer x0, Integer x1, Integer y0, Integer y1, BlurAsyncPostRequest blurAsyncPostRequest, BigDecimal sigma) throws ApiException {
    // verify the required parameter 'x0' is set
    if (x0 == null) {
    ...
    // verify the required parameter 'blurAsyncPostRequest' is set
    if (blurAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'blurAsyncPostRequest' when calling blurpartialSyncPost");
    }
