...
import io.imager200.model.BlendRequest;
...
public class BlendApi {
  ...
  public BlendApi(ApiClient apiClient) {
   ...
   */
  public InfoResponse blendAsyncPost(BlendRequest payload) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = blendAsyncPostWithHttpInfo(payload);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> blendAsyncPostWithHttpInfo(BlendRequest payload) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blendAsyncPostRequestBuilder(payload);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("blendAsyncPost", localVarResponse);
        }
  ...
  private HttpRequest.Builder blendAsyncPostRequestBuilder(BlendRequest payload) throws ApiException {
    // verify the required parameter 'payload' is set
    if (payload == null) {
      throw new ApiException(400, "Missing the required parameter 'payload' when calling blendAsyncPost");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/blend";
   ...
   * @throws ApiException if fails to make API call
   */
  public File blendSyncPost(BlendRequest payload) throws ApiException {
    ApiResponse<File> localVarResponse = blendSyncPostWithHttpInfo(payload);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> blendSyncPostWithHttpInfo(BlendRequest payload) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = blendSyncPostRequestBuilder(payload);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("blendSyncPost", localVarResponse);
        }
  ...
  private HttpRequest.Builder blendSyncPostRequestBuilder(BlendRequest payload) throws ApiException {
    // verify the required parameter 'payload' is set
    if (payload == null) {
      throw new ApiException(400, "Missing the required parameter 'payload' when calling blendSyncPost");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/blend/sync";
