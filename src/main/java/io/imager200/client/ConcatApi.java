...
import io.imager200.model.ConcatRequest;
...
public class ConcatApi {
  ...
  public ConcatApi(ApiClient apiClient) {
   ...
   * @param payload request (required)
   * @return InfoResponse
   * @throws ApiException if fails to make API call
   */
  public InfoResponse concatAsyncPost(ConcatRequest payload) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = concatAsyncPostWithHttpInfo(payload);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> concatAsyncPostWithHttpInfo(ConcatRequest payload) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = concatAsyncPostRequestBuilder(payload);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("concatAsyncPost", localVarResponse);
        }
  ...
  private HttpRequest.Builder concatAsyncPostRequestBuilder(ConcatRequest payload) throws ApiException {
    // verify the required parameter 'payload' is set
    if (payload == null) {
      throw new ApiException(400, "Missing the required parameter 'payload' when calling concatAsyncPost");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/concat";
    ...
    try {
      byte[] localVarPostBody = memberVarObjectMapper.writeValueAsBytes(payload);
   ...
   * @throws ApiException if fails to make API call
   */
  public File concatSyncPost(ConcatRequest payload) throws ApiException {
    ApiResponse<File> localVarResponse = concatSyncPostWithHttpInfo(payload);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> concatSyncPostWithHttpInfo(ConcatRequest payload) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = concatSyncPostRequestBuilder(payload);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("concatSyncPost", localVarResponse);
        }
  ...
  private HttpRequest.Builder concatSyncPostRequestBuilder(ConcatRequest payload) throws ApiException {
    // verify the required parameter 'payload' is set
    if (payload == null) {
      throw new ApiException(400, "Missing the required parameter 'payload' when calling concatSyncPost");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/concat/sync";
