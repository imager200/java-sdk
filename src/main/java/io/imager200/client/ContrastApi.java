...
public class ContrastApi {
  ...
  public ContrastApi(ApiClient apiClient) {
   ...
   * @param percentage controls the contrast level (optional, default to 0)
   * @return InfoResponse
   * @throws ApiException if fails to make API call
   */
  public InfoResponse contrastAsyncGet(String url, BigDecimal percentage) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = contrastAsyncGetWithHttpInfo(url, percentage);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> contrastAsyncGetWithHttpInfo(String url, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = contrastAsyncGetRequestBuilder(url, percentage);
    try {
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("contrastAsyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder contrastAsyncGetRequestBuilder(String url, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling contrastAsyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/contrast";
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse contrastAsyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = contrastAsyncPostWithHttpInfo(brightnessAsyncPostRequest, percentage);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> contrastAsyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = contrastAsyncPostRequestBuilder(brightnessAsyncPostRequest, percentage);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("contrastAsyncPost", localVarResponse);
        }
        return new ApiResponse<InfoResponse>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder contrastAsyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling contrastAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File contrastSyncGet(String url, BigDecimal percentage) throws ApiException {
    ApiResponse<File> localVarResponse = contrastSyncGetWithHttpInfo(url, percentage);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> contrastSyncGetWithHttpInfo(String url, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = contrastSyncGetRequestBuilder(url, percentage);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("contrastSyncGet", localVarResponse);
        }
  ...
  private HttpRequest.Builder contrastSyncGetRequestBuilder(String url, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'url' is set
    if (url == null) {
      throw new ApiException(400, "Missing the required parameter 'url' when calling contrastSyncGet");
    }

    HttpRequest.Builder localVarRequestBuilder = HttpRequest.newBuilder();

    String localVarPath = "/contrast/sync";
   ...
   * @throws ApiException if fails to make API call
   */
  public File contrastSyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    ApiResponse<File> localVarResponse = contrastSyncPostWithHttpInfo(brightnessAsyncPostRequest, percentage);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> contrastSyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = contrastSyncPostRequestBuilder(brightnessAsyncPostRequest, percentage);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        if (localVarResponse.statusCode()/ 100 != 2) {
          throw getApiException("contrastSyncPost", localVarResponse);
        }
        return new ApiResponse<File>(
          localVarResponse.statusCode(),
          localVarResponse.headers().map(),
  ...
  private HttpRequest.Builder contrastSyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling contrastSyncPost");
    }
