...
public class ContrastApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse contrastAsyncPost(File body, BigDecimal percentage) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = contrastAsyncPostWithHttpInfo(body, percentage);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> contrastAsyncPostWithHttpInfo(File body, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = contrastAsyncPostRequestBuilder(body, percentage);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder contrastAsyncPostRequestBuilder(File body, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling contrastAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File contrastSyncPost(File body, BigDecimal percentage) throws ApiException {
    ApiResponse<File> localVarResponse = contrastSyncPostWithHttpInfo(body, percentage);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> contrastSyncPostWithHttpInfo(File body, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = contrastSyncPostRequestBuilder(body, percentage);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder contrastSyncPostRequestBuilder(File body, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'body' is set
    if (body == null) {
      throw new ApiException(400, "Missing the required parameter 'body' when calling contrastSyncPost");
    }
