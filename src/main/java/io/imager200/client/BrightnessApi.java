...
public class BrightnessApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public InfoResponse brightnessAsyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    ApiResponse<InfoResponse> localVarResponse = brightnessAsyncPostWithHttpInfo(brightnessAsyncPostRequest, percentage);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<InfoResponse> brightnessAsyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = brightnessAsyncPostRequestBuilder(brightnessAsyncPostRequest, percentage);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder brightnessAsyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling brightnessAsyncPost");
    }
   ...
   * @throws ApiException if fails to make API call
   */
  public File brightnessSyncPost(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    ApiResponse<File> localVarResponse = brightnessSyncPostWithHttpInfo(brightnessAsyncPostRequest, percentage);
    return localVarResponse.getData();
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<File> brightnessSyncPostWithHttpInfo(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = brightnessSyncPostRequestBuilder(brightnessAsyncPostRequest, percentage);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
  ...
  private HttpRequest.Builder brightnessSyncPostRequestBuilder(BrightnessAsyncPostRequest brightnessAsyncPostRequest, BigDecimal percentage) throws ApiException {
    // verify the required parameter 'brightnessAsyncPostRequest' is set
    if (brightnessAsyncPostRequest == null) {
      throw new ApiException(400, "Missing the required parameter 'brightnessAsyncPostRequest' when calling brightnessSyncPost");
    }
