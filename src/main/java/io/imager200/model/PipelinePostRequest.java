 ...
 */
@JsonPropertyOrder({
  PipelinePostRequest.JSON_PROPERTY_PAYLOAD
})
...
public class PipelinePostRequest {
  public static final String JSON_PROPERTY_PAYLOAD = "payload";
  private File payload;

  public PipelinePostRequest() { 
  }

  public PipelinePostRequest payload(File payload) {
  ...
  /**
   * Return true if this pipeline_post_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PipelinePostRequest pipelinePostRequest = (PipelinePostRequest) o;
    return Objects.equals(this.payload, pipelinePostRequest.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class PipelinePostRequest {\n");
