 ...
 */
@JsonPropertyOrder({
  BlurAsyncPostRequest.JSON_PROPERTY_PAYLOAD
})
...
public class BlurAsyncPostRequest {
  public static final String JSON_PROPERTY_PAYLOAD = "payload";
  private File payload;

  public BlurAsyncPostRequest() { 
  }

  public BlurAsyncPostRequest payload(File payload) {
  ...
  /**
   * Return true if this blur_async_post_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BlurAsyncPostRequest blurAsyncPostRequest = (BlurAsyncPostRequest) o;
    return Objects.equals(this.payload, blurAsyncPostRequest.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class BlurAsyncPostRequest {\n");
