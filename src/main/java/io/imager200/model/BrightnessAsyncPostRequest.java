 ...
 */
@JsonPropertyOrder({
  BrightnessAsyncPostRequest.JSON_PROPERTY_PAYLOAD
})
...
public class BrightnessAsyncPostRequest {
  public static final String JSON_PROPERTY_PAYLOAD = "payload";
  private File payload;

  public BrightnessAsyncPostRequest() { 
  }

  public BrightnessAsyncPostRequest payload(File payload) {
  ...
  /**
   * Return true if this brightness_async_post_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    BrightnessAsyncPostRequest brightnessAsyncPostRequest = (BrightnessAsyncPostRequest) o;
    return Objects.equals(this.payload, brightnessAsyncPostRequest.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class BrightnessAsyncPostRequest {\n");
