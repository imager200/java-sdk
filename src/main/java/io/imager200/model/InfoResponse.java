 ...
 */
@JsonPropertyOrder({
  InfoResponse.JSON_PROPERTY_INFO
})
...
public class InfoResponse {
  ...
  public InfoResponse info(String info) {
    this.info = info;
    return this;
  }
  ...
  /**
   * Return true if this InfoResponse object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.info, infoResponse.info);
  }
  ...
  public String toUrlQueryString(String prefix) {
    ...
    if (getInfo() != null) {
      joiner.add(String.format("%sinfo%s=%s", prefix, suffix, URLEncoder.encode(ApiClient.valueToString(getInfo()), StandardCharsets.UTF_8).replaceAll("\\+", "%20")));
    }
