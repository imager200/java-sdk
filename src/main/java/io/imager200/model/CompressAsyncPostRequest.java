 ...
 */
@JsonPropertyOrder({
  CompressAsyncPostRequest.JSON_PROPERTY_PAYLOAD
})
...
public class CompressAsyncPostRequest {
  public static final String JSON_PROPERTY_PAYLOAD = "payload";
  private File payload;

  public CompressAsyncPostRequest() { 
  }

  public CompressAsyncPostRequest payload(File payload) {
    this.payload = payload;
    return this;
  }

  /**
   * image binary data, acceptable formats: jpeg,png
   * @return payload
   */
  ...
  /**
   * Return true if this compress_async_post_request object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CompressAsyncPostRequest compressAsyncPostRequest = (CompressAsyncPostRequest) o;
    return Objects.equals(this.payload, compressAsyncPostRequest.payload);
  }
  ...
  public String toString() {
    ...
    sb.append("class CompressAsyncPostRequest {\n");
