...
/**
 * API tests for BlurApi
 */
@Disabled
public class BlurApiTest {

    private final BlurApi api = new BlurApi();
     ...
     */
    @Test
    public void blurAsyncGetTest() throws ApiException {
        String url = null;
        BigDecimal sigma = null;
        InfoResponse response = 
        api.blurAsyncGet(url, sigma);
     ...
     */
    @Test
    public void blurAsyncPostTest() throws ApiException {
        BlurAsyncPostRequest blurAsyncPostRequest = null;
        BigDecimal sigma = null;
        InfoResponse response = 
        api.blurAsyncPost(blurAsyncPostRequest, sigma);
     ...
     */
    @Test
    public void blurSyncGetTest() throws ApiException {
        String url = null;
        BigDecimal sigma = null;
        File response = 
        api.blurSyncGet(url, sigma);
     ...
     */
    @Test
    public void blurSyncPostTest() throws ApiException {
        BlurAsyncPostRequest blurAsyncPostRequest = null;
        BigDecimal sigma = null;
        File response = 
        api.blurSyncPost(blurAsyncPostRequest, sigma);
