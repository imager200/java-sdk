 ...
 */
@Disabled
public class ImageinfoApiTest {

    private final ImageinfoApi api = new ImageinfoApi();
     ...
     */
    @Test
    public void imageinfoSyncGetTest() throws ApiException {
        String url = null;
        ImageMetadata response = 
        api.imageinfoSyncGet(url);
     ...
     */
    @Test
    public void imageinfoSyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        ImageMetadata response = 
        api.imageinfoSyncPost(brightnessAsyncPostRequest);
