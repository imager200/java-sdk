...
/**
 * API tests for BlendApi
 */
@Disabled
public class BlendApiTest {

    private final BlendApi api = new BlendApi();
     ...
     */
    @Test
    public void blendAsyncPostTest() throws ApiException {
        BlendRequest payload = null;
        InfoResponse response = 
        api.blendAsyncPost(payload);
     ...
     */
    @Test
    public void blendSyncPostTest() throws ApiException {
        BlendRequest payload = null;
        File response = 
        api.blendSyncPost(payload);
