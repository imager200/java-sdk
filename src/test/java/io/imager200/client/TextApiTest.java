...
public class TextApiTest {
     ...
     */
    @Test
    public void textAsyncGetTest() throws ApiException {
        String url = null;
        String text = null;
        String color = null;
        String font = null;
        ...
        api.textAsyncGet(url, text, color, font, size, x, y);
     ...
     */
    @Test
    public void textAsyncPostTest() throws ApiException {
        String text = null;
        ...
        Integer y = null;
        InfoResponse response = 
        api.textAsyncPost(text, brightnessAsyncPostRequest, color, font, size, x, y);
     ...
     */
    @Test
    public void textSyncGetTest() throws ApiException {
        String url = null;
        String text = null;
        String color = null;
        String font = null;
        ...
        Integer y = null;
        File response = 
        api.textSyncGet(url, text, color, font, size, x, y);
     ...
     */
    @Test
    public void textSyncPostTest() throws ApiException {
        String text = null;
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        String color = null;
        String font = null;
        ...
        Integer y = null;
        File response = 
        api.textSyncPost(text, brightnessAsyncPostRequest, color, font, size, x, y);
