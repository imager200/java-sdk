...
public class PipelineApiTest {
     ...
     */
    @Test
    public void pipelineGetTest() throws ApiException {
        String url = null;
        String name = null;
        SuccessResponse response = 
        api.pipelineGet(url, name);
     ...
     */
    @Test
    public void pipelineGetStatusTest() throws ApiException {
        String executionId = null;
        PipelineExecutionResult response = 
        api.pipelineGetStatus(executionId);
    ...
    public void pipelinePostTest() throws ApiException {
        String name = null;
        PipelinePostRequest pipelinePostRequest = null;
        SuccessResponse response = 
        api.pipelinePost(name, pipelinePostRequest);
