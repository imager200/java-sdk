...
/**
 * API tests for BrightnessApi
 */
@Disabled
public class BrightnessApiTest {

    private final BrightnessApi api = new BrightnessApi();
     ...
     */
    @Test
    public void brightnessAsyncGetTest() throws ApiException {
        String url = null;
        BigDecimal percentage = null;
        InfoResponse response = 
        api.brightnessAsyncGet(url, percentage);
     ...
     */
    @Test
    public void brightnessAsyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        BigDecimal percentage = null;
        InfoResponse response = 
        api.brightnessAsyncPost(brightnessAsyncPostRequest, percentage);
     ...
     */
    @Test
    public void brightnessSyncGetTest() throws ApiException {
        String url = null;
        BigDecimal percentage = null;
        File response = 
        api.brightnessSyncGet(url, percentage);
     ...
     */
    @Test
    public void brightnessSyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        BigDecimal percentage = null;
        File response = 
        api.brightnessSyncPost(brightnessAsyncPostRequest, percentage);
