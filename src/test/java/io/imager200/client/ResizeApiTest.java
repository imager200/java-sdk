...
public class ResizeApiTest {
     ...
     */
    @Test
    public void resizeAsyncGetTest() throws ApiException {
        String url = null;
        Integer height = null;
        Integer width = null;
        String resamplingAlgorithm = null;
        InfoResponse response = 
        api.resizeAsyncGet(url, height, width, resamplingAlgorithm);
     ...
     */
    @Test
    public void resizeAsyncPostTest() throws ApiException {
        Integer height = null;
        Integer width = null;
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        String resamplingAlgorithm = null;
        InfoResponse response = 
        api.resizeAsyncPost(height, width, brightnessAsyncPostRequest, resamplingAlgorithm);
     ...
     */
    @Test
    public void resizeSyncGetTest() throws ApiException {
        String url = null;
        Integer height = null;
        Integer width = null;
        String resamplingAlgorithm = null;
        File response = 
        api.resizeSyncGet(url, height, width, resamplingAlgorithm);
     ...
     */
    @Test
    public void resizeSyncPostTest() throws ApiException {
        Integer height = null;
        Integer width = null;
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        String resamplingAlgorithm = null;
        File response = 
        api.resizeSyncPost(height, width, brightnessAsyncPostRequest, resamplingAlgorithm);
