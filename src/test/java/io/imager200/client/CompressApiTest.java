...
/**
 * API tests for CompressApi
 */
@Disabled
public class CompressApiTest {

    private final CompressApi api = new CompressApi();
     ...
     */
    @Test
    public void compressAsyncGetTest() throws ApiException {
        String url = null;
        Integer jpegQuality = null;
        Integer pngOptimizationLevel = null;
        Boolean progressiveJpeg = null;
        InfoResponse response = 
        api.compressAsyncGet(url, jpegQuality, pngOptimizationLevel, progressiveJpeg);
     ...
     */
    @Test
    public void compressAsyncPostTest() throws ApiException {
        CompressAsyncPostRequest compressAsyncPostRequest = null;
        Integer jpegQuality = null;
        Integer pngOptimizationLevel = null;
        Boolean progressiveJpeg = null;
        InfoResponse response = 
        api.compressAsyncPost(compressAsyncPostRequest, jpegQuality, pngOptimizationLevel, progressiveJpeg);
     ...
     */
    @Test
    public void compressSyncGetTest() throws ApiException {
        String url = null;
        Integer jpegQuality = null;
        Integer pngOptimizationLevel = null;
        Boolean progressiveJpeg = null;
        File response = 
        api.compressSyncGet(url, jpegQuality, pngOptimizationLevel, progressiveJpeg);
     ...
     */
    @Test
    public void compressSyncPostTest() throws ApiException {
        CompressAsyncPostRequest compressAsyncPostRequest = null;
        Integer jpegQuality = null;
        Integer pngOptimizationLevel = null;
        Boolean progressiveJpeg = null;
        File response = 
        api.compressSyncPost(compressAsyncPostRequest, jpegQuality, pngOptimizationLevel, progressiveJpeg);
