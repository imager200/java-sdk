...
/**
 * API tests for ContrastApi
 */
@Disabled
public class ContrastApiTest {

    private final ContrastApi api = new ContrastApi();
     ...
     */
    @Test
    public void contrastAsyncGetTest() throws ApiException {
        String url = null;
        BigDecimal percentage = null;
        InfoResponse response = 
        api.contrastAsyncGet(url, percentage);
     ...
     */
    @Test
    public void contrastAsyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        BigDecimal percentage = null;
        InfoResponse response = 
        api.contrastAsyncPost(brightnessAsyncPostRequest, percentage);
     ...
     */
    @Test
    public void contrastSyncGetTest() throws ApiException {
        String url = null;
        BigDecimal percentage = null;
        File response = 
        api.contrastSyncGet(url, percentage);
     ...
     */
    @Test
    public void contrastSyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        BigDecimal percentage = null;
        File response = 
        api.contrastSyncPost(brightnessAsyncPostRequest, percentage);
