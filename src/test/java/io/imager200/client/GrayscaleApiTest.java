...
/**
 * API tests for GrayscaleApi
 */
@Disabled
public class GrayscaleApiTest {

    private final GrayscaleApi api = new GrayscaleApi();
     ...
     */
    @Test
    public void grayscaleAsyncGetTest() throws ApiException {
        String url = null;
        InfoResponse response = 
        api.grayscaleAsyncGet(url);
     ...
     */
    @Test
    public void grayscaleAsyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        InfoResponse response = 
        api.grayscaleAsyncPost(brightnessAsyncPostRequest);
     ...
     */
    @Test
    public void grayscaleSyncGetTest() throws ApiException {
        String url = null;
        File response = 
        api.grayscaleSyncGet(url);
     ...
     */
    @Test
    public void grayscaleSyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        File response = 
        api.grayscaleSyncPost(brightnessAsyncPostRequest);
