...
/**
 * API tests for RotateApi
 */
@Disabled
public class RotateApiTest {

    private final RotateApi api = new RotateApi();
     ...
     */
    @Test
    public void rotateAsyncGetTest() throws ApiException {
        String url = null;
        BigDecimal angle = null;
        String backgroundColor = null;
        InfoResponse response = 
        api.rotateAsyncGet(url, angle, backgroundColor);
     ...
     */
    @Test
    public void rotateAsyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        BigDecimal angle = null;
        String backgroundColor = null;
        InfoResponse response = 
        api.rotateAsyncPost(brightnessAsyncPostRequest, angle, backgroundColor);
     ...
     */
    @Test
    public void rotateSyncGetTest() throws ApiException {
        String url = null;
        BigDecimal angle = null;
        String backgroundColor = null;
        File response = 
        api.rotateSyncGet(url, angle, backgroundColor);
     ...
     */
    @Test
    public void rotateSyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        BigDecimal angle = null;
        String backgroundColor = null;
        File response = 
        api.rotateSyncPost(brightnessAsyncPostRequest, angle, backgroundColor);
