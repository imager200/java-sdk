...
/**
 * API tests for ConcatApi
 */
@Disabled
public class ConcatApiTest {

    private final ConcatApi api = new ConcatApi();
     ...
     */
    @Test
    public void concatAsyncPostTest() throws ApiException {
        ConcatRequest payload = null;
        InfoResponse response = 
        api.concatAsyncPost(payload);
     ...
     */
    @Test
    public void concatSyncPostTest() throws ApiException {
        ConcatRequest payload = null;
        File response = 
        api.concatSyncPost(payload);
