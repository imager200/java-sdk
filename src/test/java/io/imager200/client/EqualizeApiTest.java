...
/**
 * API tests for EqualizeApi
 */
@Disabled
public class EqualizeApiTest {

    private final EqualizeApi api = new EqualizeApi();
     ...
     */
    @Test
    public void equalizeAsyncGetTest() throws ApiException {
        String url = null;
        InfoResponse response = 
        api.equalizeAsyncGet(url);
     ...
     */
    @Test
    public void equalizeAsyncPostTest() throws ApiException {
        BlurAsyncPostRequest blurAsyncPostRequest = null;
        InfoResponse response = 
        api.equalizeAsyncPost(blurAsyncPostRequest);
     ...
     */
    @Test
    public void equalizeSyncGetTest() throws ApiException {
        String url = null;
        File response = 
        api.equalizeSyncGet(url);
     ...
     */
    @Test
    public void equalizeSyncPostTest() throws ApiException {
        BlurAsyncPostRequest blurAsyncPostRequest = null;
        File response = 
        api.equalizeSyncPost(blurAsyncPostRequest);
