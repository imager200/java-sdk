...
public class ConvertApiTest {
     ...
     */
    @Test
    public void convertAsyncGetTest() throws ApiException {
        String url = null;
        String targetFormat = null;
        InfoResponse response = 
        api.convertAsyncGet(url, targetFormat);
     ...
     */
    @Test
    public void convertAsyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        String targetFormat = null;
        InfoResponse response = 
        api.convertAsyncPost(brightnessAsyncPostRequest, targetFormat);
     ...
     */
    @Test
    public void convertSyncGetTest() throws ApiException {
        String url = null;
        String targetFormat = null;
        File response = 
        api.convertSyncGet(url, targetFormat);
     ...
     */
    @Test
    public void convertSyncPostTest() throws ApiException {
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        String targetFormat = null;
        File response = 
        api.convertSyncPost(brightnessAsyncPostRequest, targetFormat);
