...
/**
 * API tests for BlurhashApi
 */
@Disabled
public class BlurhashApiTest {

    private final BlurhashApi api = new BlurhashApi();
     ...
     */
    @Test
    public void blurhashAsyncGetTest() throws ApiException {
        String url = null;
        InfoResponse response = 
        api.blurhashAsyncGet(url);
     ...
     */
    @Test
    public void blurhashAsyncPostTest() throws ApiException {
        BlurAsyncPostRequest blurAsyncPostRequest = null;
        InfoResponse response = 
        api.blurhashAsyncPost(blurAsyncPostRequest);
     ...
     */
    @Test
    public void blurhashSyncGetTest() throws ApiException {
        String url = null;
        File response = 
        api.blurhashSyncGet(url);
     ...
     */
    @Test
    public void blurhashSyncPostTest() throws ApiException {
        BlurAsyncPostRequest blurAsyncPostRequest = null;
        File response = 
        api.blurhashSyncPost(blurAsyncPostRequest);
