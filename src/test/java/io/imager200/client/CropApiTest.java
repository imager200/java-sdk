...
/**
 * API tests for CropApi
 */
@Disabled
public class CropApiTest {

    private final CropApi api = new CropApi();
     ...
     */
    @Test
    public void cropAsyncGetTest() throws ApiException {
        String url = null;
        Integer x0 = null;
        Integer x1 = null;
        Integer y0 = null;
        ...
        api.cropAsyncGet(url, x0, x1, y0, y1);
     ...
     */
    @Test
    public void cropAsyncPostTest() throws ApiException {
        Integer x0 = null;
        Integer x1 = null;
        Integer y0 = null;
        Integer y1 = null;
        ...
        InfoResponse response = 
        api.cropAsyncPost(x0, x1, y0, y1, brightnessAsyncPostRequest);
     ...
     */
    @Test
    public void cropSyncGetTest() throws ApiException {
        String url = null;
        Integer x0 = null;
        Integer x1 = null;
        Integer y0 = null;
        Integer y1 = null;
        File response = 
        api.cropSyncGet(url, x0, x1, y0, y1);
     ...
     */
    @Test
    public void cropSyncPostTest() throws ApiException {
        Integer x0 = null;
        Integer x1 = null;
        Integer y0 = null;
        Integer y1 = null;
        BrightnessAsyncPostRequest brightnessAsyncPostRequest = null;
        File response = 
        api.cropSyncPost(x0, x1, y0, y1, brightnessAsyncPostRequest);
